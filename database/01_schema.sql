...
--      Mỗi bản ghi là một ngày làm việc của một bác sĩ.
-- ================================================================
CREATE TABLE IF NOT EXISTS doctor_schedules (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY uq_schedule_doctor_date (doctor_id, date),
  CONSTRAINT fk_schedule_doctor
    FOREIGN KEY (doctor_id) REFERENCES doctors(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
  COMMENT='Lịch làm việc theo ngày — mỗi ngày một bản ghi, chứa nhiều khung giờ khám (slots)';
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  related_id INT UNSIGNED     NULL DEFAULT NULL                 COMMENT 'ID đối tượng liên quan (appointment_id, reminder_id, ...) để điều hướng khi bấm',
  ...
  COMMENT='Thông báo cá nhân — nhắc thuốc, cập nhật lịch hẹn và thông báo hệ thống từ Admin';
...
-- ================================================================
--  Kết thúc file schema. Chạy file 02_seed.sql để nạp dữ liệu mẫu.
-- ================================================================
