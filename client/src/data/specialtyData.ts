...
export const SPECIALTIES: Specialty[] = [
  ...
  {
    id: 1,
    name: 'Tim Mạch & Can Thiệp Tim Mạch',
    slug: 'tim-mach',
    icon: 'heart',
    doctorCount: 8,
    group: 'internal',
    ...
    commonDiseases: ['Tăng huyết áp', 'Suy tim', 'Rối loạn nhịp tim', 'Nhồi máu cơ tim', 'Bệnh van tim'],
    staffTypes: ['Bác sĩ Chuyên khoa I, II', 'Tiến sĩ', 'Phó Giáo sư', 'Giáo sư'],
  },
  {
    id: 2,
    ...
    commonDiseases: ['Viêm loét dạ dày', 'Xơ gan', 'Viêm gan B/C', 'Trào ngược dạ dày', 'Polyp đại tràng'],
  ...
  },
  {
    ...
    commonDiseases: ['Đái tháo đường type 2', 'Cường/suy giáp', 'Loãng xương', 'Béo phì chuyển hóa', 'Buồng trứng đa nang'],
    staffTypes: ['Bác sĩ Chuyên khoa I, II', 'Tiến sĩ', 'Phó Giáo sư'],
  },
  {
    id: 4,
    ...
    commonDiseases: ['Viêm phổi trẻ em', 'Sốt xuất huyết', 'Còi xương', 'Tiêu chảy cấp', 'Hen phế quản trẻ em'],
    staffTypes: ['Bác sĩ Nhi khoa CKI, CKII', 'Tiến sĩ Nhi', 'Điều dưỡng Nhi chuyên biệt'],
  },
  {
    id: 5,
    name: 'Hô Hấp',
    ...
    commonDiseases: ['Hen suyễn', 'COPD', 'Viêm phổi', 'Lao phổi', 'Ung thư phổi giai đoạn sớm'],
    staffTypes: ['Bác sĩ Chuyên khoa I, II', 'Tiến sĩ', 'Kỹ thuật viên đo hô hấp'],
  },
  {
    id: 6,
    name: 'Thần Kinh Nội',
    ...
    commonDiseases: ['Đột quỵ não', 'Động kinh', 'Parkinson', 'Đau đầu Migraine', 'Viêm màng não'],
    staffTypes: ['Bác sĩ Chuyên khoa I, II Thần kinh', 'Tiến sĩ', 'Phó Giáo sư'],
  },
  {
    id: 7,
    name: 'Da Liễu',
    ...
    commonDiseases: ['Viêm da cơ địa', 'Vảy nến', 'Mụn trứng cá nặng', 'Nấm da', 'Dị ứng da'],
    staffTypes: ['Bác sĩ Da liễu CKI, CKII', 'Tiến sĩ', 'Kỹ thuật viên laser thẩm mỹ'],
  },
  {
    id: 8,
    name: 'Ung Bướu',
    ...
    commonDiseases: ['Ung thư vú', 'Ung thư đại tràng', 'Ung thư gan', 'Ung thư phổi', 'U lympho'],
    staffTypes: ['Bác sĩ Ung thư CKI, CKII', 'Tiến sĩ', 'Phó Giáo sư', 'Dược sĩ hóa trị'],
  },
  ...
  // ── Chuyên khoa Ngoại ─────────────────────────────────────────────────────
  {
    ...
    commonDiseases: ['U xơ tử cung', 'Viêm phần phụ', 'Thai ngoài tử cung', 'Lạc nội mạc tử cung', 'Ung thư cổ tử cung'],
    staffTypes: ['Bác sĩ Sản CKI, CKII', 'Tiến sĩ', 'Nữ hộ sinh', 'Điều dưỡng Sản'],
  },
  {
    id: 10,
    ...
    commonDiseases: ['Gãy xương', 'Thoát vị đĩa đệm', 'Thoái hóa khớp gối', 'Đứt dây chằng', 'Viêm khớp dạng thấp'],
    staffTypes: ['Bác sĩ Chỉnh hình CKI, CKII', 'Tiến sĩ', 'Kỹ thuật viên phục hồi chức năng'],
  },
  {
    id: 11,
    name: 'Tai - Mũi - Họng',
    ...
    commonDiseases: ['Viêm mũi xoang mãn', 'Viêm amygdal', 'Ù tai mất thính lực', 'Polyp mũi', 'Viêm họng mãn'],
  ...
  },
  {
    ...
    commonDiseases: ['Đục thủy tinh thể', 'Glaucoma', 'Thoái hóa điểm vàng', 'Viêm màng bồ đào', 'Cận thị nặng'],
  ...
  },
  {
    ...
    commonDiseases: ['Sâu răng phức tạp', 'Viêm nha chu', 'Răng khôn mọc lệch', 'Rối loạn khớp hàm', 'U nang vùng hàm'],
    staffTypes: ['Bác sĩ RHM CKI, CKII', 'Tiến sĩ', 'Kỹ thuật viên phục hình răng'],
  },
  {
    id: 14,
    ...
    commonDiseases: ['Chấn thương sọ não', 'U não lành/ác tính', 'Thoát vị đĩa đệm cổ/thắt lưng nặng', 'Phình động mạch não', 'Tụ máu nội sọ'],
    staffTypes: ['Bác sĩ Phẫu thuật Thần kinh CKI, CKII', 'Tiến sĩ', 'Phó Giáo sư'],
  },
  {
    id: 15,
    name: 'Tiết Niệu',
    ...
    commonDiseases: ['Sỏi thận/bàng quang', 'Phì đại tuyến tiền liệt', 'Ung thư thận', 'Nhiễm khuẩn tiết niệu tái phát', 'Tiểu không kiểm soát'],
    staffTypes: ['Bác sĩ Tiết niệu CKI, CKII', 'Tiến sĩ', 'Kỹ thuật viên nội soi'],
  },
  ...
  // ── Chuyên khoa Hỗ Trợ ───────────────────────────────────────────────────
  {
    ...
    commonDiseases: ['Siêu âm thai sản', 'CT ngực tầm soát ung thư', 'MRI não/cột sống', 'X-quang xương khớp', 'Siêu âm tim'],
    staffTypes: ['Bác sĩ CĐHA CKI, CKII', 'Tiến sĩ', 'Kỹ thuật viên X-quang/MRI'],
  },
  {
    id: 17,
    name: 'Xét Nghiệm',
    ...
    commonDiseases: ['Xét nghiệm máu tổng quát', 'Sinh hóa gan/thận', 'Dấu ấn ung thư', 'Cấy khuẩn kháng sinh đồ', 'Giải phẫu bệnh'],
    staffTypes: ['Bác sĩ Xét nghiệm CKI, CKII', 'Cử nhân Xét nghiệm', 'Kỹ thuật viên phòng lab'],
  },
  {
    id: 18,
    ...
    commonDiseases: ['Phục hồi sau đột quỵ', 'Đau thắt lưng mãn tính', 'Liệt sau chấn thương', 'Thoái hóa khớp', 'Phục hồi sau thay khớp'],
    staffTypes: ['Bác sĩ Phục hồi CKI, CKII', 'Cử nhân VLTL', 'Kỹ thuật viên trị liệu vận động'],
  },
  {
    id: 19,
    name: 'Dinh Dưỡng',
    ...
    commonDiseases: ['Đái tháo đường chế độ ăn', 'Béo phì', 'Suy dinh dưỡng trẻ em', 'Bệnh thận chế độ ăn đặc biệt', 'Rối loạn ăn uống'],
    staffTypes: ['Bác sĩ Dinh dưỡng CKI', 'Cử nhân Dinh dưỡng', 'Kỹ thuật viên tiết chế'],
  },
  {
    id: 20,
    name: 'Khoa Dược',
    ...
    commonDiseases: ['Tư vấn dùng thuốc mãn tính', 'Kiểm soát tương tác thuốc', 'Dược lâm sàng nội trú', 'Quản lý thuốc kiểm soát', 'Dược cảnh giác'],
    staffTypes: ['Dược sĩ Chuyên khoa I, II', 'Tiến sĩ Dược', 'Dược sĩ lâm sàng'],
  },
];
...
export const GROUP_META: Record<Specialty['group'], { label: string; description: string }> = {
  internal: {
    label: 'Chuyên khoa nội',
    description: 'Chẩn đoán và điều trị nội khoa các bệnh lý mãn tính và cấp tính không cần phẫu thuật.',
  },
  surgical: {
    label: 'Chuyên khoa ngoại',
    description: 'Can thiệp phẫu thuật và điều trị ngoại khoa bằng kỹ thuật nội soi và vi phẫu hiện đại.',
  },
  support: {
    label: 'Chuyên khoa hỗ trợ',
    description: 'Hỗ trợ chẩn đoán, xét nghiệm và phục hồi chức năng cho các chuyên khoa lâm sàng.',
  },
};
