...
export const SPECIALTY_GROUPS = [
  {
    ...
    items: [
      ...
      { label: 'specialties.gastroenterology', path: '/specialties/tieu-hoa-gan-mat' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'specialties.orthopedics',   path: '/specialties/chan-thuong-chinh-hinh' },
      ...
      { label: 'specialties.neurosurgery',  path: '/specialties/phau-thuat-than-kinh' },
  ...
  },
  {
    ...
    items: [
      { label: 'specialties.radiology',        path: '/specialties/chan-doan-hinh-anh' },
      { label: 'specialties.laboratory',       path: '/specialties/xet-nghiem' },
      { label: 'specialties.physical_therapy', path: '/specialties/vat-ly-tri-lieu' },
...
export const NEWS_CATEGORIES = [
  { label: 'news_categories.events',  slug: 'su-kien',    path: '/news?category=su-kien',    banner: 'https://picsum.photos/seed/hospital-event/1440/400' },
  { label: 'news_categories.press',   slug: 'bao-chi',    path: '/news?category=bao-chi',    banner: 'https://picsum.photos/seed/press-medical/1440/400' },
  { label: 'news_categories.promos',  slug: 'uu-dai',     path: '/news?category=uu-dai',     banner: 'https://picsum.photos/seed/health-promotion/1440/400' },
  { label: 'news_categories.cases',   slug: 'ca-benh',    path: '/news?category=ca-benh',    banner: 'https://picsum.photos/seed/success-surgery/1440/400' },
  { label: 'news_categories.reviews', slug: 'cam-nhan',   path: '/news?category=cam-nhan',   banner: 'https://picsum.photos/seed/patient-care/1440/400' },
  { label: 'news_categories.medical', slug: 'chuyen-mon', path: '/news?category=chuyen-mon', banner: 'https://picsum.photos/seed/doctor-expert/1440/400' },
  { label: 'news_categories.gallery', slug: 'thu-vien',   path: '/news?category=thu-vien',   banner: 'https://picsum.photos/seed/gallery-clinic/1440/400' },
] as const;

export const PATIENT_GUIDE_DROPDOWN = [
  { label: 'guide_dropdown.outpatient', path: '/help?tab=kham-ngoai-tru', icon: 'medicine' },
  { label: 'guide_dropdown.inpatient',  path: '/help?tab=nhap-vien',      icon: 'home' },
  { label: 'guide_dropdown.payment',    path: '/help?tab=thanh-toan',     icon: 'credit-card' },
  { label: 'guide_dropdown.amenities',  path: '/help?tab=tien-ich',       icon: 'star' },
  { label: 'guide_dropdown.visit',      path: '/help?tab=tham-benh',      icon: 'team' },
];

export const SERVICES_DROPDOWN = [
  { label: 'services_dropdown.specialist', path: '/services?cat=kham-chuyen-khoa',  icon: 'medicine' },
  { label: 'services_dropdown.general',    path: '/services?cat=goi-kham-tong-quat', icon: 'heart' },
  { label: 'services_dropdown.lab',        path: '/services?cat=xet-nghiem',         icon: 'experiment' },
  { label: 'services_dropdown.vaccine',    path: '/services?cat=tiem-chung',         icon: 'safety' },
  { label: 'services_dropdown.surgery',    path: '/services?cat=phau-thuat',         icon: 'scan' },
  { label: 'services_dropdown.digital',    path: '/services?cat=dich-vu-so',         icon: 'video' },
];
