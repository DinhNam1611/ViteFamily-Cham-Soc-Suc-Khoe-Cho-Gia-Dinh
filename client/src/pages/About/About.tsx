          ...
          <div className={`container ${styles.heroContent}`}>
            ...
            >
              ...
              <p className={styles.heroSub}>
                Hơn 15 năm đồng hành cùng sức khỏe cộng đồng — chuyên nghiệp, tận tâm, đáng tin cậy
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className={`container ${styles.introGrid}`}>
            ...
            >
              ...
              <h2 className={styles.sectionTitle}>
                Bệnh viện Quốc tế <span>đầu tiên</span> tại Hà Nội & Miền Bắc Việt Nam
              </h2>
              <p className={styles.desc}>
                Thành lập năm 2007, VitaFamily là bệnh viện tư nhân tiên phong mang tiêu chuẩn y tế
                quốc tế đến với người dân Hà Nội và toàn miền Bắc Việt Nam. Với hơn 15 năm không
                ngừng phát triển, chúng tôi hiện là một trong những bệnh viện quốc tế hàng đầu khu
                vực, phục vụ cả bệnh nhân Việt Nam lẫn bệnh nhân nước ngoài.
              </p>
              <p className={styles.desc}>
                Tọa lạc tại trung tâm quận Đống Đa, VitaFamily cung cấp đầy đủ các dịch vụ y tế
                chuyên khoa, tuân thủ nghiêm ngặt các tiêu chuẩn an toàn và chất lượng quốc tế,
                đồng thời đáp ứng đầy đủ các quy định của Bộ Y tế Việt Nam.
              </p>
            ...
            >
              <img
                ...
                alt="Cơ sở VitaFamily — tòa nhà bệnh viện hiện đại"
          ...
          <div className={`container ${styles.milestoneGrid}`}>
            ...
            >
              <img
                ...
                alt="Vườn hoa bệnh viện VitaFamily"
          ...
          <div className="container">
            ...
            >
              ...
              <p className={styles.awardsSubtitle}>
                Những thành tựu minh chứng cho cam kết không ngừng nâng cao chất lượng dịch vụ y tế
              </p>
            </motion.div>
          ...
          <div className={`container ${styles.ctaGrid}`}>
            ...
            >
              ...
              <p className={styles.ctaDesc}>
                VitaFamily là nơi làm việc lý tưởng cho những chuyên gia y tế xuất sắc. Chúng tôi
                cung cấp môi trường làm việc quốc tế, trang thiết bị y tế tiên tiến hàng đầu và đội
                ngũ bác sĩ có trình độ cao. Nếu bạn muốn trở thành một phần của gia đình VitaFamily,
